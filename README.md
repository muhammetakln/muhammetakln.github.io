[index.html](https://github.com/user-attachments/files/28150887/index.html)
<!DOCTYPE html>
<html lang="tr">
<head>
    <meta charset="UTF-8">
    ...
    <div class="container">
        ...
        <section class="hero" id="about">
            <div class="hero-content">
                ...
                <div class="btn-group">
                    <a href="https://github.com/muhammetakln" target="_blank" class="btn btn-primary">
            ...
            <div class="projects-grid">
                ...
                <div class="project-card">
                    <div class="project-top">
                        ...
                        <div class="project-links">
                            <a href="https://github.com/muhammetakln" target="_blank"><i class="fab fa-github"></i></a>
                        </div>
                    </div>
                    <div>
                ...
                <div class="project-card">
                    <div class="project-top">
                        <i class="far fa-folder folder-icon"></i>
                        <div class="project-links">
                            <a href="https://github.com/muhammetakln/ECommerce" target="_blank"><i class="fab fa-github"></i></a>
                        </div>
                    </div>
                    <div>
